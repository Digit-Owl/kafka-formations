...
public class OwlKStreamRunner implements CommandLineRunner {
    ...
    public OwlKStreamRunner(SpecificAvroSerde<Owl> owlSpecificAvroSerde, Properties kstreamProperties) {
    ...
    public void run(String... args) {
        try {
            OwlKStreamTopology owlKStreamTopology = new OwlKStreamTopology(inputTopicName, outputTopicName, kstreamProperties, owlSpecificAvroSerde);
